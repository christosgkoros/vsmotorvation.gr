...
const faq = [
  ...
  },
  {
    ...
    a: "Το συνεργείο άνοιξε τον Ιούλιο του 2026, οι μηχανικοί όμως όχι: έρχονται από χρόνια σε συνεργεία και από την αντιπροσωπεία της Piaggio. Μπορείτε να δείτε τι λένε οι πρώτοι πελάτες στις κριτικές μας στους Χάρτες Google.",
  },
  {
