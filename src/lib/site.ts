...
export const site = {
  ...
  description:
    "Εξειδικευμένο συνεργείο μοτοσυκλετών με έμφαση στη BMW Motorrad. Service, διάγνωση, φρένα, αναρτήσεις, ελαστικά και upgrades — με σεβασμό στη μηχανή σας.",
