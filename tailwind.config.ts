    ...
    extend: {
      colors: {
        ...
        vs: {
          ...
          bright: "#3D7BE8",
          /**
           * Για ΚΕΙΜΕΝΟ πάνω σε σκούρο. Το vs-bright πέφτει στο 3.9:1 πάνω
           * στο ink-600, κάτω από το 4.5:1 που απαιτεί το WCAG AA. Το accent
           * δίνει ≥5:1 σε όλα τα ink, μένοντας στην ίδια οικογένεια.
           * Τα vs-blue / vs-bright παραμένουν για γεμίσματα και περιγράμματα.
           */
          accent: "#5B93F0",
          deep: "#1B3E86",
          red: "#DC3A2B",
